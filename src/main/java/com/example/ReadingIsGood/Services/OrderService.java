...
public class OrderService {
    ...
    public List<OrderModel> getAllOrdersBetweenDates(LocalDate startDate, LocalDate endDate) {
    ...
    public List<OrderModel> getAllCustomerOrdersPagable(String customerId, PageRequest pageRequest) {
        return orderRepository.findOrderModelByCustomerId(customerId, pageRequest);
    }
